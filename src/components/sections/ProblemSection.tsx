...
const PAIN_POINTS = [
  {
    ...
    body: "Most loyalty platforms charge a hefty monthly fee plus a percentage of every transaction. As your clinic grows, their cut grows with it. You are penalized for your own success.",
    iconBg: "bg-red-50",
  ...
  },
  {
    ...
    body: "Loyalty rates, tier names, reward structures, home screen layout — all locked to defaults. You pay premium prices for a one-size-fits-all experience.",
    iconBg: "bg-orange-50",
      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        <AnimateIn className="text-center max-w-3xl mx-auto mb-14">
          <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-extrabold leading-tight tracking-tight text-dark mb-4">
            Tired of paying a percentage of every sale?
          </h2>
        ...
        <AnimateIn delay={0.1}>
          <div className="bg-primary-dark rounded-2xl p-8 sm:p-10 text-center">
            <p className="text-xl sm:text-2xl font-bold text-white leading-snug max-w-3xl mx-auto mb-3">
              The average clinic pays over <span className="text-accent-light">$8,880 per year</span> in
